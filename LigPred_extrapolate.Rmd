...
```{r vs_lvl5_leave1out, echo=FALSE,message=FALSE,warning=FALSE,fig.height=4,fig.width=7}
...
```{r lvl4_confusion}
CT <- "VCAP"
table(true=factor(lvl4_data@cdesc[testIDs[[CT]],"pert_iname"],levels=lig16),
                          predicted=lvl4_rfresults[[CT]]$predictions)
```
