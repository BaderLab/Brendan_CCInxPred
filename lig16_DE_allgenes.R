...
for (Z in Zpercent) {
  ...
  save(meanZlig_all,countDElig,pDElig,
       file=paste0("~/Dropbox/GDB_archive/CMapCorr_files/lig16_DE_allgenes_lig_",
...
for (Z in Zpercent) {
  ...
  save(meanZct_all,countDEct,pDEct,
       file=paste0("~/Dropbox/GDB_archive/CMapCorr_files/lig16_DE_allgenes_ct_",
                   names(Zpercent)[Zpercent == Z],
                   ".RData"))
}
...
for (Z in Zpercent) {
  ...
  save(meanZligct,countDEligct,pDEligct,scoreDEligct,
       file=paste0("~/Dropbox/GDB_archive/CMapCorr_files/lig16_DE_allgenes_ligct_",
                   names(Zpercent)[Zpercent == Z],
                   ".RData"))
}
...
for (Z in Zpercent) {
  ...
  save(meanZrep,samples_rep,countDErep,pDErep,scoreDErep,
       file=paste0("~/Dropbox/GDB_archive/CMapCorr_files/lig16_DE_allgenes_rep_",
                   names(Zpercent)[Zpercent == Z],
                   ".RData"))
}
