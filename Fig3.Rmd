...
load("~/Dropbox/GDB/CMapCorr/Fig3_ct.RData")
scoreDEct <- pDEct + 1e-4
scoreDEct[scoreDEct > 1] <- 1
scoreDEct <- -log10(scoreDEct)

load("~/Dropbox/GDB/CMapCorr/Fig3_lig.RData")
scoreDElig <- pDElig + 1e-4
scoreDElig[scoreDElig > 1] <- 1
scoreDElig <- -log10(scoreDElig)

load("~/Dropbox/GDB/CMapCorr/Fig3_ligct.RData")
load("~/Dropbox/GDB/CMapCorr/Fig3_rep.RData")
