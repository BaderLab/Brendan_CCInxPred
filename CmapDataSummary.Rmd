...
```{r lvl4_umap, echo=FALSE,message=FALSE,warning=FALSE,fig.height=6,fig.width=9,fig.show='hold'}
...
plot(lvl4_umap$layout,pch=".",xaxt="n",yaxt="n",
...
temp_col <- qualitative_hcl(length(levels(temp_col)),palette="dark3",alpha=.7)[temp_col]
plot(lvl4_umap$layout,pch=".",xaxt="n",yaxt="n",
     main="Coloured by plate",xlab="UMAP1",ylab="UMAP2",
     col=temp_col)
...
temp_col <- qualitative_hcl(length(levels(temp_col)),palette="dark3",alpha=.7)[temp_col]
plot(lvl4_umap_lig16$layout,pch=".",xaxt="n",yaxt="n",
     main="Coloured by cell line",xlab="UMAP1",ylab="UMAP2",
     col=temp_col)
