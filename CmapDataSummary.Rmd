...
```{r lvl3_data_summary, echo=FALSE,message=FALSE,warning=FALSE,fig.height=5,fig.width=8,fig.show='hold'}
...
```{r lvl3_data_dist, echo=FALSE,message=FALSE,warning=FALSE,fig.show='hold'}
...
```{r lvl3_umap, echo=FALSE,message=FALSE,warning=FALSE,fig.height=3,fig.width=9,fig.show='hold'}
if (file.exists("../CMapCorr_files/200630_lvl3_umap.RData")) {
  load("../CMapCorr_files/200630_lvl3_umap.RData") 
} else {
...
```{r lvl3_umap_ct, echo=FALSE,message=FALSE,warning=FALSE,fig.height=15,fig.width=9,fig.show='hold'}
if (file.exists("../CMapCorr_files/200630_lvl3_ctUMAP.RData")) {
  load("../CMapCorr_files/200630_lvl3_ctUMAP.RData") 
} else {
  source("200326_lvl3_umap.R")
}
...
```{r lvl3_umap_lig, echo=FALSE,message=FALSE,warning=FALSE,fig.height=17,fig.width=9,fig.show='hold'}
if (file.exists("../CMapCorr_files/200630_lvl3_ligUMAP.RData")) {
  load("../CMapCorr_files/200630_lvl3_ligUMAP.RData") 
} else {
  source("200326_lvl3_umap.R")
}
...
```{r lvl4_data_dist, echo=FALSE,message=FALSE,warning=FALSE,fig.show='hold'}
...
```{r lvl4_umap, echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=9,fig.show='hold'}
par(mfrow=c(3,3),mar=c(1.5,1,1,0.5),mgp=c(0,0,0))

if (file.exists("../CMapCorr_files/200630_lvl4_umap.RData")) {
  load("../CMapCorr_files/200630_lvl4_umap.RData") 
} else {
...
if (file.exists("../CMapCorr_files/200630_lvl4_umap_lig16.RData")) {
  load("../CMapCorr_files/200630_lvl4_umap_lig16.RData") 
} else {
  source("200326_lvl4_umap.R")
}
...
if (file.exists("../CMapCorr_files/200721_lvl4all_umap_lig16.RData")) {
  load("../CMapCorr_files/200721_lvl4all_umap_lig16.RData") 
} else {
  source("200326_lvl4_umap.R")
}
...
```{r lvl4_umap_ct, echo=FALSE,message=FALSE,warning=FALSE,fig.height=15,fig.width=9,fig.show='hold'}
if (file.exists("../CMapCorr_files/200630_lvl4_ctUMAP.RData")) {
  load("../CMapCorr_files/200630_lvl4_ctUMAP.RData") 
} else {
...
```{r lvl4_umap_lig, echo=FALSE,message=FALSE,warning=FALSE,fig.height=17,fig.width=9,fig.show='hold'}
if (file.exists("../CMapCorr_files/200630_lvl4_ligUMAP.RData")) {
  load("../CMapCorr_files/200630_lvl4_ligUMAP.RData") 
} else {
  source("200326_lvl4_umap.R")
}
...
```{r lvl4_umap_ct_all, echo=FALSE,message=FALSE,warning=FALSE,fig.height=15,fig.width=9,fig.show='hold'}
if (file.exists("../CMapCorr_files/200721_lvl4all_ctUMAP.RData")) {
  load("../CMapCorr_files/200721_lvl4all_ctUMAP.RData") 
} else {
  source("200327_lvl4_umap.R")
}
...
```{r lvl4_umap_lig_all, echo=FALSE,message=FALSE,warning=FALSE,fig.height=17,fig.width=9,fig.show='hold'}
if (file.exists("../CMapCorr_files/200721_lvl4all_ligUMAP.RData")) {
  load("../CMapCorr_files/200721_lvl4all_ligUMAP.RData") 
} else {
  source("200326_lvl4_umap.R")
}
...
```{r lvl5_data_summary, echo=FALSE, message=FALSE, warning=FALSE, fig.height=5, fig.width=8, fig.show='hold'}
temp_ct <- sapply(ct14,function(X) 
...
```{r lvl5_data_dist, echo=FALSE, message=FALSE, warning=FALSE, fig.show='hold'}
temp <- sapply(lig16,function(X)
...
```{r lvl5_umap, echo=FALSE,message=FALSE,warning=FALSE,fig.height=6,fig.width=9,fig.show='hold'}
par(mfrow=c(2,3),mar=c(1.5,1,1,0.5),mgp=c(0,0,0))

if (file.exists("../CMapCorr_files/200701_lvl5_umap.RData")) {
  load("../CMapCorr_files/200701_lvl5_umap.RData") 
} else {
...
if (file.exists("../CMapCorr_files/200701_lvl5_umap_lig16.RData")) {
  load("../CMapCorr_files/200701_lvl5_umap_lig16.RData") 
} else {
  source("200701_lvl5_umap.R")
}
...
```{r lvl5_umap_ct, echo=FALSE,message=FALSE,warning=FALSE,fig.height=15,fig.width=9,fig.show='hold'}
if (file.exists("../CMapCorr_files/200701_lvl5_ctUMAP.RData")) {
  load("../CMapCorr_files/200701_lvl5_ctUMAP.RData") 
} else {
...
```{r lvl5_umap_lig, echo=FALSE,message=FALSE,warning=FALSE,fig.height=17,fig.width=9,fig.show='hold'}
if (file.exists("../CMapCorr_files/200701_lvl5_ligUMAP.RData")) {
  load("../CMapCorr_files/200701_lvl5_ligUMAP.RData") 
} else {
  source("200701_lvl5_umap.R")
}
