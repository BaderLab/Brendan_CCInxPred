...
meanZ <- sapply(lig295,function(LIG) {
...
meanZ_lig <- sapply(lig295,function(LIG)
...
save(meanZ_lig,FDR_lig,pDE_lig,
     file=paste0("~/Dropbox/GDB_archive/CMapCorr_files/lig295_DE_lig_FDR.RData"))
...
meanZ_ct <- sapply(ct9,function(CT)
...
save(meanZ_ct,FDR_ct,pDE_ct,
     file=paste0("~/Dropbox/GDB_archive/CMapCorr_files/lig295_DE_ct_FDR.RData"))
...
meanZ_ligct <- sapply(ct9,function(CT) {
  sapply(lig295,function(LIG) {
    rowMeans(lvl4_data@mat[,lvl4_data@cdesc$cell_id == CT &
...
save(meanZ_ligct,FDR_ligct,pDE_ligct,
     file=paste0("~/Dropbox/GDB_archive/CMapCorr_files/lig295_DE_ligct_FDR.RData"))
...
save(meanZ_rep,FDR_rep,pDE_rep,
     file=paste0("~/Dropbox/GDB_archive/CMapCorr_files/lig295_DE_rep_FDR.RData"))
rm(list=grep("ligct$",ls(),value=T))
rm(list=grep("^temp",ls(),value=T))
