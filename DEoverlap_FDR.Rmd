...
```{r echo=F,message=F,warning=F,fig.height=4,fig.width=9}
temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/lig16_DE_allgenes_lig_FDR.RData")
DE_heatmap(FDR_lig,pDE_lig,"Ligands",aCut=0.1)
rm(list=temp)
```
...
temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/lig295_DE_allgenes_lig_FDR.RData")
DE_heatmap(FDR_lig,pDE_lig,"Ligands",aCut=0.1)
rm(list=temp)
```
...
```{r echo=F,message=F,warning=F,fig.height=4,fig.width=9}
temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/lig16_DE_allgenes_ct_FDR.RData")
try(DE_heatmap(FDR_ct,pDE_ct,"Cell lines",aCut=0.1),silent=F)
rm(list=temp)
```
...
```{r echo=F,message=F,warning=F,fig.height=4,fig.width=9}
temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/lig295_DE_allgenes_ct_FDR.RData")
try(DE_heatmap(FDR_ct,pDE_ct,"Cell lines",aCut=0.1),silent=F)
rm(list=temp)
```
...
```{r echo=F,message=F,warning=F,fig.height=6,fig.width=8}
temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/lig16_DE_allgenes_ligct_FDR.RData")
DE_heatmap(FDR_ligct,pDE_ligct,"Ligands per cell line",aCut=0.001)
```
...
```{r echo=F,message=F,warning=F,fig.height=8,fig.width=9}
temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/lig295_DE_allgenes_ligct_FDR.RData")
DE_heatmap(FDR_ligct,pDE_ligct,"Ligands per cell line",aCut=0.001)
```
...
# BoxP(c("16 ligands, all genes"="lig16_DE_allgenes"))
```
