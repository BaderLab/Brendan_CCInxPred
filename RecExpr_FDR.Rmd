...
```
```{r lig_DE, echo=F,message=F,warning=F,fig.height=6,fig.width=9}
...
```{r rec_DE_corr_detail,echo=FALSE,message=FALSE,warning=FALSE,fig.height=9,fig.width=9,fig.show='hold'}
