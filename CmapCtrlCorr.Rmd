...
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200615_lvl3ctlcorr.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200615_lvl3ctlcorr.RData") 
} else {
...
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200617_lvl3corr.RData")) {
  load("~/Dropbox/GDB_archive/CMapCorr_files/200617_lvl3corr.RData") 
} else {
  source("200615_ctlcorr_inputs.R")
}
...
```{r lvl3_corr_hist_ctrl, echo=FALSE,message=FALSE,warning=FALSE,fig.height=12,fig.width=9,fig.show='hold'}
...
hist(corr_ctl_tx,breaks=100,xlim=c(temp_min,1),
     ...
     main="Correlation between controls by cell line per treatment condition")
...
abline(v=median(corr_ctl_tx),lwd=2,col="dodgerblue")
temp_diff <- wilcox.test(corr_ctl_tx,corr_ctl_plate)
legend("topleft",bty="n",lwd=c(2,2,NA),col=c("red","dodgerblue",NA),
       legend=c("Median PCC between replicate controls by plate",
                "Median PCC between replicate controls",
                paste("Wilcoxon rank-sum test p =",
                      signif(temp_diff$p.value,4))))
...
hist(corr_ct,breaks=100,xlim=c(temp_min,1),
     xlab="Pairwise Pearson correlation coefficient",
     main="Correlation between treatments by cell line")
abline(v=median(corr_ct),lwd=2,col="red")
abline(v=median(corr_lig),lwd=2,col="dodgerblue")
temp_diff <- wilcox.test(corr_ct,corr_lig)
legend("topleft",bty="n",lwd=c(2,2,NA),col=c("red","dodgerblue",NA),
       legend=c("Median PCC between treatments by cell line",
                "Median PCC between treatments by ligand",
                paste("Wilcoxon rank-sum test p =",
                      signif(temp_diff$p.value,4))))

hist(corr_lig_ct,breaks=100,xlim=c(temp_min,1),
     xlab="Pairwise Pearson correlation coefficient",
     main="Correlation between treatments by ligand per cell line")
abline(v=median(corr_lig_ct),lwd=2,col="red")
abline(v=median(corr_ct),lwd=2,col="dodgerblue")
temp_diff <- wilcox.test(corr_lig_ct,corr_ct)
legend("topleft",bty="n",lwd=c(2,2,NA),col=c("red","dodgerblue",NA),
       legend=c("Median PCC between treatments by ligand per cell line",
                "Median PCC between treatments by cell line",
                paste("Wilcoxon rank-sum test p =",
                      signif(temp_diff$p.value,4))))

hist(corr_lig_tx,breaks=100,xlim=c(temp_min,1),
     xlab="Pairwise Pearson correlation coefficient",
     main="Correlation between treatment replicates (same dose / time)")
abline(v=median(corr_lig_tx),lwd=2,col="red")
abline(v=median(corr_lig_ct),lwd=2,col="dodgerblue")
temp_diff <- wilcox.test(corr_lig_tx,corr_lig_ct)
legend("topleft",bty="n",lwd=c(2,2,NA),col=c("red","dodgerblue",NA),
       legend=c("Median PCC between treatment replicates",
                "Median PCC between treatments by ligand per cell line",
                paste("Wilcoxon rank-sum test p =",
                      signif(temp_diff$p.value,4))))

```

```{r lvl3_corr_cleanup, echo=FALSE,message=FALSE,warning=FALSE}
...
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200625_lvl4corr.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200625_lvl4corr.RData") 
} else {
  source("200615_ctlcorr_inputs.R")
}
...
```{r lvl4_corr_hist, echo=FALSE,message=FALSE,warning=FALSE,fig.height=8,fig.width=9,fig.show='hold'}
par(mfrow=c(4,1),mar=c(3,3,2,1),mgp=c(2,1,0))

hist(corr_ct,breaks=100,xlim=c(-1,1),
     xlab="Pairwise Spearman correlation coefficient",
     main="Correlation of treatment Z-scores by cell line")
abline(v=median(corr_ct),lwd=2,col="red")
legend("topleft",bty="n",lwd=2,col="red",legend="Median SCC")

hist(corr_lig,breaks=100,xlim=c(-1,1),
     xlab="Pairwise Spearman correlation coefficient",
     main="Correlation of treatment Z-scores by ligand")
abline(v=median(corr_ct),lwd=2,col="red")
abline(v=median(corr_lig),lwd=2,col="dodgerblue")
temp_diff <- wilcox.test(corr_ct,corr_lig)
legend("topleft",bty="n",lwd=c(2,2,NA),col=c("red","dodgerblue",NA),
       legend=c("Median SCC of treatment Z-scores by ligand",
                "Median SCC of treatment Z-scores by cell line",
                paste("Wilcoxon rank-sum test p =",
                      signif(temp_diff$p.value,4))))

hist(corr_lig_ct,breaks=100,xlim=c(-1,1),
     xlab="Pairwise Spearman correlation coefficient",
     main="Correlation of treatment Z-scores by ligand per cell line")
abline(v=median(corr_lig_ct),lwd=2,col="red")
abline(v=median(corr_lig),lwd=2,col="dodgerblue")
temp_diff <- wilcox.test(corr_lig_ct,corr_lig)
legend("topleft",bty="n",lwd=c(2,2,NA),col=c("red","dodgerblue",NA),
       legend=c("Median SCC of treatment Z-scores by ligand per cell line",
                "Median SCC of treatment Z-scores by cell line",
                paste("Wilcoxon rank-sum test p =",
                      signif(temp_diff$p.value,4))))

hist(corr_lig_tx,breaks=100,xlim=c(-1,1),
     xlab="Pairwise Spearman correlation coefficient",
     main="Correlation of replicate treatment Z-scores (same dose / time)")
abline(v=median(corr_lig_tx),lwd=2,col="red")
abline(v=median(corr_lig_ct),lwd=2,col="dodgerblue")
temp_diff <- wilcox.test(corr_lig_tx,corr_lig_ct)
legend("topleft",bty="n",lwd=c(2,2,NA),col=c("red","dodgerblue",NA),
       legend=c("Median SCC of replicate treatment Z-scores",
                "Median SCC of treatment Z-scores by ligand per cell line",
                paste("Wilcoxon rank-sum test p =",
                      signif(temp_diff$p.value,4))))
...
```{r lvl4_corr_cleanup, echo=FALSE,message=FALSE,warning=FALSE}
rm(list=c(grep("^corr_",ls(),value=T),grep("^temp",ls(),value=T)))
```
...
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200624_lvl4jacc.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200624_lvl4jacc.RData") 
} else {
...
if (exists("lvl4_OVLPact_ct")) {
  temp <- NULL
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl4_OVLP_ct.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl4_OVLP_ct.RData") 
} else {
...
if (exists("lvl4_OVLPact_lig")) {
  temp <- NULL
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl4_OVLP_lig.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl4_OVLP_lig.RData") 
} else {
  source("200624_DEoverlaptest.R")
}
...
if (exists("lvl4_OVLPact_lig_ct")) {
  temp <- NULL
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl4_OVLP_lig_ct.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl4_OVLP_lig_ct.RData") 
} else {
  source("200624_DEoverlaptest.R")
}
...
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200617_lvl5corr.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200617_lvl5corr.RData") 
} else {
  source("200615_ctlcorr_inputs.R")
}
...
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200624_lvl5jacc.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200624_lvl5jacc.RData") 
} else {
  source("200624_DEjaccard.R")
}
...
if (exists("lvl5_OVLPact_ct")) {
  temp <- NULL
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl5_OVLP_ct.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl5_OVLP_ct.RData") 
} else {
  source("200624_DEoverlaptest.R")
}
...
if (exists("lvl5_OVLPact_lig")) {
  temp <- NULL
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl5_OVLP_lig.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl5_OVLP_lig.RData") 
} else {
  source("200624_DEoverlaptest.R")
}
...
if (exists("lvl5_OVLPact_lig_ct")) {
  temp <- NULL
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl5_OVLP_lig_ct.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200702_lvl5_OVLP_lig_ct.RData") 
} else {
  source("200624_DEoverlaptest.R")
}
...
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200706_lvl4newcorr.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200706_lvl4newcorr.RData") 
} else {
  source("200615_ctlcorr_inputs.R")
}
...
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200706_lvl4newjacc.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200706_lvl4newjacc.RData") 
} else {
  source("200624_DEjaccard.R")
}
...
if (exists("lvl4new_OVLPact_ct")) {
  temp <- NULL
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200707_lvl4new_OVLP_ct.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200707_lvl4new_OVLP_ct.RData") 
} else {
  source("200624_DEoverlaptest.R")
}
...
if (exists("lvl4new_OVLPact_lig")) {
  temp <- NULL
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200707_lvl4new_OVLP_lig.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200707_lvl4new_OVLP_lig.RData") 
} else {
  source("200624_DEoverlaptest.R")
}
...
if (exists("lvl4new_OVLPact_lig_ct")) {
  temp <- NULL
} else if (file.exists("~/Dropbox/GDB_archive/CMapCorr_files/200707_lvl4new_OVLP_lig_ct.RData")) {
  temp <- load("~/Dropbox/GDB_archive/CMapCorr_files/200707_lvl4new_OVLP_lig_ct.RData") 
} else {
  source("200624_DEoverlaptest.R")
}
