...
mtext(paste("Change in probability of # DE",
            "when cell line context is considered",
            sep="\n"),
      side=2,line=2)
```
...
There were `r length(consistentLIG)` ligands out of 295 (`r round(100 * length(consistentLIG) / 295)`%) that **did not** show improvement in consistency of transcriptional response when considering cell line context.  The following figures show the responsive genes in each case:  
