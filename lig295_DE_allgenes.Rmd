...
load("~/Dropbox/GDB_archive/CMapCorr_files/Fig3allgenes_ct.RData")
scoreDEct <- pDEct + 1e-4
scoreDEct[scoreDEct > 1] <- 1
scoreDEct <- -log10(scoreDEct)

load("~/Dropbox/GDB_archive/CMapCorr_files/Fig3allgenes_lig.RData")
scoreDElig <- pDElig + 1e-4
scoreDElig[scoreDElig > 1] <- 1
scoreDElig <- -log10(scoreDElig)

load("~/Dropbox/GDB_archive/CMapCorr_files/Fig3allgenes_ligct.RData")
load("~/Dropbox/GDB_archive/CMapCorr_files/Fig3allgenes_rep.RData")
