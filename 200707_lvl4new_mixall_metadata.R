...
temp_data_frame <- cbind(lvl4new_data@cdesc[,c("cell_id","pert_dose","pert_time")],
                         as.data.frame(t(lvl4new_data@mat)))
...
save(rfmodel,rfresults,trainIDs,testIDs,
     file="~/Dropbox/GDB_archive/CMapCorr_files/200707_lvl4new_mixall_balanced_saturated_metadata.RData")
