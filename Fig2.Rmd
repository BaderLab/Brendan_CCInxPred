...
```{r lig, echo=F,message=F,warning=F,fig.height=6,fig.width=8,dpi=300}
...
```{r ct, echo=F,message=F,warning=F,fig.height=6,fig.width=8,dpi=300}
...
```{r lig_ct, echo=F,message=F,warning=F,fig.height=6,fig.width=8,dpi=300}
...
```{r rep, echo=F,message=F,warning=F,fig.height=4,fig.width=8,dpi=300}
...
```{r compare_all, echo=F,message=F,warning=F,fig.height=10,fig.width=8,dpi=300}
